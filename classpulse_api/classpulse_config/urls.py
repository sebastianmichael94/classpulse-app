...
urlpatterns = [
    ...
    path('api/auth/forgot-password/', StudentForgotPasswordView.as_view()),
    path('api/professor/quizzes/history/', ProfessorQuizHistoryView.as_view()),
    path('api/analytics/live/', LiveAnalyticsView.as_view()),
    path('api/analytics/summary/', AnalyticsSummaryView.as_view()),
    path('api/analytics/chat/', AnalyticsChatView.as_view()),
